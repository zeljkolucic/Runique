package com.zeljkolucic.run.presentation.active_run.maps
...
object PolylineColorCalculator {
    fun locationsToColor(location1: LocationTimestamp, location2: LocationTimestamp): Color {
        ...
        val timeDifference = abs((location1.durationTimestamp - location2.durationTimestamp).inWholeSeconds)
        val speedKmh = (distanceMeters / timeDifference) * 3.6
    ...
    private fun interpolateColor(
        ...
        val colorInt = if(ratio <= 0.5) {
            ...
            ColorUtils.blendARGB(colorStart.toArgb(), colorMid.toArgb(), midToEndRatio.toFloat())
        }
